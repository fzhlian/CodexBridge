...
const EN_MESSAGES = {
  ...
  "chat.task.state.intentRouter": "intent={intent} router={router}",
  "chat.info.threadCleared": "Thread cleared.",
  "chat.info.copiedToClipboard": "Copied to clipboard.",
  "chat.info.applyRequestedForRefId": "Apply requested for refId={refId}",
  "chat.info.retriedTask": "Retried task {taskId}.",
  ...
  "chat.task.attachment.testOutputTitle": "Test Output",
  "chat.task.attachment.commandOutputTitle": "Command Output",
  ...
  "chat.debug.modelRouterTitle": "Model Router Debug",
  ...
  "taskRunner.status.fieldOutboundIp": "outbound_ip",
...
const ZH_CN_MESSAGES: Record<MessageKey, string> = {
  ...
  "chat.task.state.intentRouter": "\u610f\u56fe={intent} \u8def\u7531={router}",
  "chat.info.threadCleared": "\u7ebf\u7a0b\u5df2\u6e05\u7a7a\u3002",
  "chat.info.copiedToClipboard": "\u5df2\u590d\u5236\u5230\u526a\u8d34\u677f\u3002",
  "chat.info.applyRequestedForRefId": "\u5df2\u8bf7\u6c42\u5e94\u7528 refId={refId}",
  "chat.info.retriedTask": "\u5df2\u91cd\u8bd5\u4efb\u52a1 {taskId}\u3002",
  ...
  "chat.task.attachment.testOutputTitle": "\u6d4b\u8bd5\u8f93\u51fa",
  "chat.task.attachment.commandOutputTitle": "\u547d\u4ee4\u8f93\u51fa",
  ...
  "chat.debug.modelRouterTitle": "\u6a21\u578b\u8def\u7531\u8c03\u8bd5\u4fe1\u606f",
  ...
  "taskRunner.status.fieldNode": "Node",
  "taskRunner.status.fieldOutboundIp": "\u51fa\u53e3IP",
